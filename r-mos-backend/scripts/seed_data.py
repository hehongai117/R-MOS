...
SEED_FAULT_CASES = [
    {
        ...
        "diagnosis_steps": ["检查温度传感器读数", "检查散热风扇是否正常", "检查环境温度"],
        "solution_steps": ["立即停机", "检查散热系统", "降低负载"]
    },
    {
        ...
        "diagnosis_steps": ["检查关节是否有异物", "检查润滑情况", "检查机械磨损"],
        "solution_steps": ["断电检查", "清理异物", "添加润滑油"]
    },
    {
        ...
        "diagnosis_steps": ["检查电池电量", "测量供电电压", "检查电源模块状态"],
        "solution_steps": ["更换电池", "检查电源模块", "检查线路"]
    },
    {
        ...
        "diagnosis_steps": ["检查传感器连接", "检查通信状态", "验证传感器数据"],
        "solution_steps": ["检查接线", "更换传感器", "屏蔽干扰"]
    },
    {
        ...
        "diagnosis_steps": ["检查关节固定螺丝", "测试重复定位精度", "检查固定件磨损"],
        "solution_steps": ["紧固螺丝", "更换固定件", "添加防松胶"]
    }
]
