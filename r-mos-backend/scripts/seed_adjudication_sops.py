...
SOP_KNEE_BEARING = {
    ...
    "steps": [
        ...
        _make_knee_step(
            ...
            ["left_knee_link"],
            "kbr-08", group_path="knee/execute", expected_action="verify_check",
            step_view={"camera": {"position": [0.34, -0.33, 0.32], "target": [0.1, -0.45, -0.02], "fov": 35}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.15},
            validations=[{
                "type": "checklist_confirmed",
                "params": {
                    "requiredItems": ["cover_screws_removed"], "confirmedItems": [],
                    "items": [{"key": "cover_screws_removed", "label": "4 颗 M4×8 覆盖件螺丝已全部退出"}],
                },
                "isRequired": True,
            }],
            tools_required=["hex_3"],
        ...
        _make_knee_step(
            ...
            ["left_knee_link"], "kbr-09", group_path="knee/execute",
            step_view={"camera": {"position": [0.36, -0.32, 0.34], "target": [0.1, -0.45, -0.02], "fov": 36}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.3},
        ),
        _make_knee_step(
        ...
        _make_knee_step(
            ...
            ["left_knee_link"],
            "kbr-11", group_path="knee/execute", expected_action="verify_check",
            step_view={"camera": {"position": [0.3, -0.35, 0.27], "target": [0.1, -0.45, -0.05], "fov": 32}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.45},
            validations=[{
                "type": "checklist_confirmed",
                "params": {
                    "requiredItems": ["bearing_seat_screws_removed"], "confirmedItems": [],
                    "items": [{"key": "bearing_seat_screws_removed", "label": "4 颗 M4×8 轴承座螺丝已全部退出"}],
                },
                "isRequired": True,
            }],
            tools_required=["hex_3"],
        ...
        _make_knee_step(
            ...
            ["left_knee_link"], "kbr-12", group_path="knee/execute",
            step_view={"camera": {"position": [0.29, -0.36, 0.24], "target": [0.1, -0.45, -0.06], "fov": 30}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.55},
        ),
        _make_knee_step(
            "kbr-12", 12, "拔取旧轴承", "保持拔取器垂直用力，拔出旧轴承，避免损伤轴座。",
            ["left_knee_link"], "kbr-13", group_path="knee/execute",
            step_view={"camera": {"position": [0.25, -0.38, 0.2], "target": [0.1, -0.45, -0.08], "fov": 28}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.7},
            is_critical=True, tools_required=["bearing_puller"],
        ),
        _make_knee_step(
            "kbr-13", 13, "清洁轴座配合面", "清除轴座配合面的旧油脂和异物并检查表面。",
            ["left_knee_link"], "kbr-14", group_path="knee/execute",
            step_view={"camera": {"position": [0.24, -0.38, 0.19], "target": [0.1, -0.45, -0.08], "fov": 28}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.7},
        ),
        _make_knee_step(
            "kbr-14", 14, "新轴承涂抹润滑脂", "在新轴承 6205-2RS 配合面均匀涂抹薄层润滑脂。",
            ["left_knee_link"], "kbr-15", group_path="knee/execute",
            step_view={"camera": {"position": [0.23, -0.39, 0.18], "target": [0.1, -0.45, -0.09], "fov": 26}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.75},
            required_parts=[{"bom_code": "grease", "name": "润滑脂", "qty": 1}],
        ),
        _make_knee_step(
            "kbr-15", 15, "压入新轴承 6205-2RS", "保持新轴承端面平正，将其压入轴座。",
            ["left_knee_link"], "kbr-16", group_path="knee/execute",
            step_view={"camera": {"position": [0.22, -0.39, 0.17], "target": [0.1, -0.45, -0.1], "fov": 25}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.75},
            required_parts=[{"bom_code": "6205-2RS", "name": "轴承", "qty": 1}],
        ),
        _make_knee_step(
            "kbr-16", 16, "装回轴承座", "对正安装基准并装回轴承座。",
            ["left_knee_link"], "kbr-17", group_path="knee/execute",
            step_view={"camera": {"position": [0.28, -0.36, 0.25], "target": [0.1, -0.45, -0.06], "fov": 31}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.5},
        ),
        _make_knee_step(
            "kbr-17", 17, "对角拧紧轴承座 4 颗螺丝", "按 1→3→2→4 的对角顺序紧固轴承座螺丝。",
            ["left_knee_link"],
            "kbr-18", group_path="knee/execute", expected_action="verify_check",
            step_view={"camera": {"position": [0.31, -0.34, 0.28], "target": [0.1, -0.45, -0.04], "fov": 33}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.35},
            required_parts=[{"bom_code": "threadlocker", "name": "螺纹胶", "qty": 1}],
            validations=[{
                "type": "checklist_confirmed",
                "params": {
                    "requiredItems": ["diagonal_order_confirmed"], "confirmedItems": [],
                    "items": [{"key": "diagonal_order_confirmed", "label": "已按 1→3→2→4 对角顺序紧固"}],
                },
                "isRequired": True,
            }],
        ...
        _make_knee_step(
            ...
            ["left_knee_link"], "kbr-19", group_path="knee/execute",
            step_view={"camera": {"position": [0.36, -0.32, 0.34], "target": [0.1, -0.45, -0.02], "fov": 36}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"], "explode": 0.15},
        ),
        _make_knee_step(
        ...
        _make_knee_step(
            ...
            ["left_knee_link"], "kbr-21", phase="verify", group_path="knee/verify", expected_action="verify_check",
            step_view={"camera": {"position": [0.65, 0.05, 0.65], "target": [0.075, -0.3, 0.0], "fov": 39}, "visibleLinks": ["left_knee_link"], "highlight": ["left_knee_link"]},
            validations=[{"type": "checklist_confirmed", "params": {
