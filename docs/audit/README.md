...
| A0 报告恢复提交 | `c324ef9f`（A0 报告、干预层证据、索引和开发记录的首个完整提交；区别于被审系统基线） |
...
- **[A0 基线与事实源审计报告（0.1.0，In Review）](./2026-08-26-a0-baseline-and-source-governance-audit-report-v0.1.0.md)**：固定 `B-REF`、`B-ASIS`、Phase 3 干预层、运行指纹、事实源分类、P0 启动初筛、A1 双源范围和窗口交接规则。当前仍待用户确认备用通知渠道、总截止日、A1 范围与 A0 报告。
