...
| 项目 | 状态 |
|---|---|
| 阶段 | **A0 Approved（2026-08-26）**；下一步 A1 全系统功能与技术资产清点。应用代码继续冻结 |
| 版本 | 0.5.1 |
| 日期 | 2026-08-26 |
...
- **[A0 基线与事实源审计报告（0.1.1，In Review）](./2026-08-26-a0-baseline-and-source-governance-audit-report-v0.1.1.md)**：明确被审对象是整个 R-MOS 项目；固定 `B-REF`、`B-ASIS`、Phase 3 干预层、全项目事实源分母、运行指纹、P0 启动初筛、A1 双源范围、本机只读服务授权边界和窗口交接规则。Phase 3 只是额外重验层，不是审计范围。
