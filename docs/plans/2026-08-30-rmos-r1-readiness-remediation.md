...
**Execution status (2026-09-02):** Tasks 1–5 completed; Task 6 remains partial. The board has now confirmed `B-REF=361eaac...`, the 2026-09-19 warning / 2026-09-25 deadline without extension, the A1 scope and the four read-only A0 probes. The probes completed: the current local database/schema, runtime route table, frontend public entry and local process/container mapping are recorded, their cleanup completed, and no probe-caused drift was observed. The original Phase 3 per-commit approval remains `UNKNOWN + MUST_REVERIFY`; historical per-stage A1–A6 comparisons and the R0 fixed-version eligibility work remain open. The board's P0 main/backup channel fields were literal placeholders, so AG-03 remains blocked despite its confirmation that the eight P0 summaries were received in the current task. A0 M-AUD-06, current-report review and final `确认 Audit A0` also remain open. A0 is `REOPENED / IN REVIEW`; A1–A6, R0 and R1 are not approved to start. Evidence: `docs/audit/2026-09-02-a0-baseline-and-source-governance-audit-report-v0.2.1.md`, `docs/audit/evidence/2026-09-02-a0-board-preconditions-confirmation-v0.1.0.md` and `docs/audit/evidence/2026-09-02-a0-approved-fingerprint-probe-results-v0.1.0.md`.
